...
function Options({openPetListed, openFavPets}) {
  ...
  return (
    <div className='w-full mt-2 md:mt-0 z-10 justify-center md:justify-end flex gap-2 md:gap-3'>
        <div onClick={() => navigate('applications')} className='bg-[#D9D9D9] hover:bg-[#cecece] duration-150 cursor-pointer justify-center flex flex-col items-center w-full sm:w-28 py-2 gap-[5px] md:gap-[6px] px-3 rounded-md'>
